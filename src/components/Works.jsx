...
const Works = () => {
  ...
  return (
    <>
      ...
      <div className="works-container mt-20 flex flex-col items-center gap-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 justify-items-center gap-6 max-w-4xl">
          {projects.slice(3, 5).map((project, index) => (
            <div key={`project-${index + 3}`} className="project-card">
              <ProjectCard index={index + 3} {...project} />
            </div>
          ))}
        </div>
      </div>
